...
2. **Brief** — goal, path, `adb/` pointers, scope, proof. Heavy: Plan writes plan + done criteria into `adb/`, MainAgent commits them before Code (the plan review's range). Do not skip Plan.
